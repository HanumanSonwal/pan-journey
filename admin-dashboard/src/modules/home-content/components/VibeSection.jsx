    ...
    <Card
      ...
      extra={
        <Button
          type="primary"
          icon={<PlusOutlined />}
          onClick={() => onCreate(HOME_CONTENT_SECTIONS.VIBE)}
        >
          Add Category
        </Button>
      }
            ...
            label: (
              <div className="flex w-full items-center justify-between pr-4">
                <div className="flex items-center gap-3">
                  ...
                  >
                    {category.items.length} Destinations
                  </span>
                </div>
                ...
                >
                  <Button
                    size="small"
                    icon={<EditOutlined />}
                    onClick={() => onEdit(HOME_CONTENT_SECTIONS.VIBE, category)}
                  >
                    Edit
                  </Button>
                    ...
                    <div className="space-y-3 p-4">
                      ...
                      >
                        <div className="space-y-2">
                          ...
                          <InfoRow label="City ID" value={place.cityId} />

                          <InfoRow label="Alt" value={place.alt} />
                        </div>
                      </div>
                    </div>
                  </div>
