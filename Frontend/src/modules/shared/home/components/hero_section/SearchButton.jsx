...
export default function SearchButton({ onSearch }) {
  return (
    <div className="/* Default/Desktop */ /* 768px */ /* 1024px */ /* ~1440px */ /* ~2560px */ absolute top-[70%] left-1/2 flex w-full -translate-x-1/2 justify-center md:top-[380px] lg:top-[380px] xl:top-[320px] 2xl:top-[283px]">
      <button
        onClick={onSearch}
