      ...
      <div className="relative h-[380px] w-full overflow-hidden rounded-[30px] md:h-[430px] lg:w-[85.87%]">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-4 text-center">
          ...
          <button
            ...
            className="h-[42px] w-[180px] rounded bg-white text-lg font-semibold !text-[#72C0F0] shadow-lg transition-all duration-200 hover:scale-[1.02] hover:opacity-90 active:scale-[0.98] md:h-10 md:w-[200px] md:text-xl"
          >
            Start Booking Now →
          </button>
        </div>
