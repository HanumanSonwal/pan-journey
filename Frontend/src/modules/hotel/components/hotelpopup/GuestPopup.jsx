    ...
    >
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-3 text-[15px] text-[#333]">
            ...
            travelers below 18 years of age cannot
            travel alone
          </p>
        </div>
      ...
      <div className="mt-10 space-y-7">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-[120px_1fr_1fr]">
          ...
          {/* First Name */}
          <div className="relative">
            <label className="absolute -top-[11px] left-4 bg-[#F5F5F5] px-1 text-[14px] text-[#222] z-10">
              First Name
            </label>
        ...
        <button
          ...
          style={{
            background:
              "linear-gradient(180deg, #7CC6F2 0%, #5CA9D8 100%)",
          }}
        >
          Save Details
        </button>
