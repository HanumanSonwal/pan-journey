      ...
      <div className="mt-5 rounded-xl border border-[#E5EEF7] bg-[#FAFCFF] px-3 py-6 sm:p-4">
        <div className="flex items-center justify-between gap-3 sm:gap-6">
          ...
          <div className="flex shrink-0 flex-col items-center">
            <div className="rounded-full border border-[#76B7E5] px-2 py-1 text-[11px] font-medium whitespace-nowrap text-[#2D8BC8] sm:px-4 sm:py-1 sm:text-[13px]">
              <ClockCircleOutlined className="mr-1" />
              {nights} Night{nights > 1 ? "s" : ""}
            </div>

            <Text className="mt-2 text-center text-[10px] whitespace-nowrap text-gray-500 sm:text-[13px]">
