...
export default function BookingHistoryTab({
  ...
  return (
    <>
      ...
      <div className="mt-[-3px] mb-5 bg-white px-6 py-3 text-gray-900">
            ...
            >
              ...
              <div className="flex flex-col gap-5 p-5 xl:flex-row xl:items-center xl:justify-between">
                ...
                <button
                  ...
                  className="h-[40px] w-[150px] rounded-lg bg-[#72C0F0] text-[15px] font-semibold text-white transition-all hover:bg-[#4A9BB5] md:w-[120px] md:text-[14px] lg:w-[150px]"
                >
                  View Booking
                </button>
              </div>
