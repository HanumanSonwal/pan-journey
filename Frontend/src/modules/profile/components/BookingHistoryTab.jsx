            ...
            >
              ...
              <div className="p-5 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5">
                ...
                <div className="flex items-start gap-4 flex-1 min-w-0">
                  ...
                  <div className="w-[56px] h-[56px] rounded-xl bg-[#edf7ff] flex items-center justify-center shrink-0">
                    <CalendarOutlined className="text-[#72C0F0] text-[20px]" />
                  </div>
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-2">
                      {/* STATUS */}
                      <div className="px-3 py-[3px] rounded-full border border-[#72C0F0] bg-[#edf7ff] text-[#72C0F0] text-[10px] font-medium">
                        {item.status}
                      </div>
                ...
                <button
                  ...
                  className="min-w-[150px] h-[40px] rounded-lg bg-[#72C0F0] hover:bg-[#5ab3ea] transition-all text-white text-[15px] font-semibold px-5"
                >
                  View Booking
                </button>
              </div>
              ...
              <div className="border-t border-gray-200 grid grid-cols-1 md:grid-cols-4">
                ...
                <div className="p-5 border-b md:border-b-0 md:border-r border-gray-200">
                  <p className="text-[14px] text-gray-500 mb-2">Check-in</p>
                  ...
                  <p className="text-[14px] text-gray-700 mt-1">{item.city}</p>
                </div>

                {/* CHECK OUT */}
                <div className="p-5 border-b md:border-b-0 md:border-r border-gray-200">
                  <p className="text-[14px] text-gray-500 mb-2">Check-out</p>
                ...
                <div className="p-5 flex items-center justify-center">
                  <button className="min-w-[190px] h-[40px] rounded-lg border border-[#244734] text-[#244734] hover:bg-[#244734] hover:text-white transition-all text-[12px] font-medium flex items-center justify-center gap-2 px-4">
                    <DownloadOutlined />
                    Download Invoice
                  </button>
                </div>
